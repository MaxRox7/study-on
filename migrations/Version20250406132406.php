 ...
 */
final class Version20250406132406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE lesson (id_lesson SERIAL NOT NULL, id_course INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, order_number INT NOT NULL, name_lesson VARCHAR(50) NOT NULL, status_lesson VARCHAR(50) NOT NULL, PRIMARY KEY(id_lesson))
        SQL);
        $this->addSql(<<<'SQL'
